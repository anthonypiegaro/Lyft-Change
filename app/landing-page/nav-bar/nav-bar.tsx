...
export function Navbar() {
  return (
    <nav className="flex justify-between items-center fixed top-0 left-0 w-full p-6 lg:px-12">
      <h1 className="text-2xl font-bold">
        Lyft<span className="text-zinc-700 dark:text-zinc-400">Change</span>
      </h1>
